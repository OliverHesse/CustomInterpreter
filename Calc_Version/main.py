...
def inputFunction():
  ...
  if function_name.find("(") == -1 or function_name.find(")") == -1 or function_name.find(" ") == -1 or function_name in functions_map:
  ...
  functions_map[function_name] = {"variables":new_variable,"tokens":new_func}
  return 0    
